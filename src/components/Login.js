      ...
      <div className='m-auto bg-[#233C3B] bg-opacity-60 py-6 px-14 rounded-2xl flex flex-col'>
        ...
        <div className='mt-4 mx-auto flex'>
          <form className='flex flex-col' onSubmit={handleSubmit(onSubmit)}>
            ...
            <button className='text-xs italic mx-auto mb-4 text-[#ead7ba] hover:text-[#ead7ba]/80 transition-colors duration-300'>{t("forgot-password")}</button>
            ...
            <button type="button" class="text-white font-bold bg-[#4CA9AF] hover:bg-[#4CA9AF]/80 transition-colors duration-300 focus:ring-4 focus:outline-none focus:ring-white/50 font-medium rounded-lg text-sm px-5 py-2.5 
